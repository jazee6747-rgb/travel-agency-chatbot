...
travel_keywords = ["travel", "trip", "tour", "package", "flight", "hotel", "visa", "booking", "destination", "price", "cost"]
...
def chat():
    ...
    if not any(word in user_msg for word in travel_keywords):
        return jsonify({"reply": "I can only assist with travel-related questions."})
    ...
    return jsonify({"reply": "Please ask about tours, flights, hotels, or visas."})
